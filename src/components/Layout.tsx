        ...
        {!isAppChrome && (
          <nav className="category-nav hidden md:block" aria-label="Marketplace">
            <div className="mx-auto flex max-w-market items-center gap-6 overflow-x-auto px-8 py-2 hide-scrollbar">
              <Link to="/marketplace" className={`category-link text-[13px] font-medium ${marketplaceActive && !categoryParam ? 'is-active' : ''}`}>
                All crafts
              </Link>
        ...
        <div className="mx-auto grid max-w-market gap-10 px-4 py-14 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
          <div className="sm:col-span-2">
            ...
            <p className="mt-3 max-w-md text-sm leading-7 text-stone-600">
              India’s modern marketplace for authentic artisan-made products — discovered by craft, material, and place.
            </p>
          </div>
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
              ...
              <Link to="/wishlist" className="hover:text-indigo">Wishlist</Link>
              <Link to="/cart" className="hover:text-indigo">Cart</Link>
            </div>
          </div>
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-stone-500">Account</p>
            <div className="mt-4 flex flex-col gap-2 text-sm text-stone-700">
              <Link to="/login" className="hover:text-indigo">Sign in</Link>
              <Link to="/orders" className="hover:text-indigo">Orders</Link>
              <Link to="/checkout" className="hover:text-indigo">Checkout</Link>
            </div>
          </div>
        </div>
        <div className="border-t border-stone-300/80">
          <p className="mx-auto max-w-market px-4 py-4 text-xs text-stone-500 lg:px-8">
            Authentic crafts, made across India.
          </p>
        </div>
      </footer>
